        ...
        <section className='w-full h-full md:py-10 mt-16 text-white  container mx-auto'>
            <div className=' flex-wrap md:flex'>
                <div className=' md:max-w-screen-lg w-full mx-auto  md:flex flex-col '>
                    ...
                    <div className='flex md:flex-col lg:flex-row md:mt-6 flex-wrap'>
                        <div className='md:mt-6 mt-6 mx-4'>
                            <h1 className='font-bold text-5xl text-black capitalize px-2'>the bright future of web 3.0 ?</h1>
                        </div>
                        <div className='md:mt-6 mt-6 mx-4'>
                ...
                <div className='text-white max-w-screen-lg bg-black px-7 md:w-fit lg:w-4/5 md:mt-6 lg:mt-6 mt-20 mx-auto'>
